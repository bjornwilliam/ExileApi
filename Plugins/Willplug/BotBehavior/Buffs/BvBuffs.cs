...
namespace Willplug.BotBehavior
{
    public static class BvBuffs
    {
        ...
        // 
        public static Composite CreateTree()
        {
            return new Decorator(delegate
            {
        ...
        public static Composite CreateUseVortexComposite()
        {
            return new Decorator(delegate
            {
                if (WillBot.Me.enemies.ClosestMonsterEntity != null && DateTime.Now.Subtract(previousVortexUseTime).TotalMilliseconds > 1200)
                {
                    return true;
                }
                return false;
                ...
                new Sequence(
                    new Action(delegate
                    {
                     ...
                     ComboHotkey(x => Keys.LControlKey, y => Keys.E))
