    ...
    public class StashieCore : BaseSettingsPlugin<StashieSettings>
    {
        ...
        private void SaveDefaultConfigsToDisk()
        {
            ...
            #region default config String
                ...
                "Unique2:\t\t\t\tRarity=Unique\t\t\t\t\t\t\t\t:Default Tabs\r\n" +
                "\r\n" +
                "//Special Items\r\n" +
        ...
        private IEnumerator ProcessInventoryItems()
        {
            ...
            PublishEvent("stashie_done", null);
        }
        ...
        public bool CheckIgnoreCells(NormalInventoryItem inventItem)
        {
        ...
        private IEnumerator DropItemsToStash()
        {
            ...
            while (_dropItems.Count > 0 && tries < 3)
            {
                tries++;
                visibleStashIndex = -1;
                ...
                foreach (var stashResults in sortedByStash)
                {
                    ...
                    if (tries == 2)
                    {
                        if (stashResults.ItemData.Rarity == ItemRarity.Unique)
                        {
                            stashResults.StashIndex = GetInventIndexByStashName("Unique dump");
                        }
                        else
                        {
                            break;
        ...
        private IEnumerator ProcessRefills()
        {
            ...
            PublishEvent("stashie_done_processing_refills", null);
        }
